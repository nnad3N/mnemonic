...
const AttachmentPreviewDialog: FC<{ children: ReactElement }> = ({
  children,
}) => {
          ...
          <TooltipTrigger
            render={
              <div
                ...
                className="aui-attachment-preview-trigger aui-attachment-tile size-14 cursor-pointer overflow-hidden rounded-[calc(var(--composer-radius)-var(--composer-padding))] border bg-muted transition-[background-color,opacity] hover:bg-accent/50 hover:opacity-75"
                role="button"
                tabIndex={0}
              />
            }
  ...
  return (
    <ComposerPrimitive.AddAttachment asChild>
      <TooltipIconButton
        ...
        variant="ghost"
        size="icon"
        className="aui-composer-add-attachment size-8 rounded-full p-1 text-xs font-semibold hover:bg-muted-foreground/15 dark:border-muted-foreground/15 dark:hover:bg-muted-foreground/30"
